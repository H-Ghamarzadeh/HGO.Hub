...
namespace HGO.Hub.Interfaces
{
    ...
    public interface IHub
    {
        ...
        /// <returns></returns>
        Task DoActionAsync<T>(T action) where T : IAction;
        ...
        Task<T> ApplyFiltersAsync<T>(T data);
        ...
        Task<TRes?> RequestAsync<TRes>(IRequest<TRes> request, bool autoApplyFiltersOnResponse = true);
    }
}
